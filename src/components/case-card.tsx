...
export function CaseCard({ item }: { item: CaseItem }) {
  return (
    <Link
      ...
      className="group flex flex-col gap-6 bg-white sm:flex-row sm:gap-8 sm:pr-8"
    >
      <div className="relative h-[240px] w-full shrink-0 overflow-hidden sm:h-[302px] sm:w-[285px]">
        <Image
          src={item.cover}
          alt={item.title}
          fill
      ...
      <div className="flex flex-1 flex-col justify-between gap-6 py-1 sm:py-4">
